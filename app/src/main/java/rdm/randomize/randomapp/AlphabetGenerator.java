...
public class AlphabetGenerator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alphabet_generator);
        ...
        Button bttgenerate = (Button)findViewById(R.id.btngeneratealphabet);
        textRandom = (TextView)findViewById(R.id.textgeneratealphabet);
